//+------------------------------------------------------------------+
//|  MoneyMachine7_v1775.mq5                                        |
//|  v17.75 — v17.73 + 4 mejoras basadas en datos reales            |
//|                                                                  |
//|  HALLAZGOS CLAVE de v17.73 (72 trades analizados):              |
//|                                                                  |
//|  1. H19 ES LA HORA MÁS DAÑINA (WR=27%, EV=-$3.81)             |
//|     H7 ahora es WR=71% EV=+$10.16 — positiva                  |
//|     H22 ahora es WR=62% EV=+$7.84 — positiva                  |
//|     → Eliminar H19, mantener H7 y H22                          |
//|                                                                  |
//|  2. MOMENTUM DE RACHA ES ESTADÍSTICAMENTE REAL                  |
//|     Tras 3 losses: WR=20%, EV=-$3.39 → PARAR ANTES             |
//|     Tras 3 wins:   WR=73%, EV=+$4.47 → APOSTAR MÁS            |
//|     → Lot dinámico por racha (×1.3 win, ×0.8 loss)             |
//|     → Pausa 8 barras tras 3 losses (no 5 tras 4)               |
//|                                                                  |
//|  3. RÉGIMEN MÁS ÁGIL                                           |
//|     Pausa tras 1 día malo (no 2), retoma tras 1 día bueno       |
//|                                                                  |
//|  SIMULACIONES (sobre datos reales v17.73):                      |
//|  - Solo lot dinámico: $298 vs $266 actual (+$32)                |
//|  - Eliminar H19: +$42 neto                                      |
//|  - Proyección combinada: ~$340+                                  |
//+------------------------------------------------------------------+
#property copyright "MoneyMachine7"
#property version   "17.75"
#property strict
...
input int    InpMagicNumber      = 177500;
...
int OnInit()
{
   ...
   Print("MM7 v17.75 | ",g_sym,
         " | Horas:2,7,15,22 (H19 eliminada WR=27%)",
         " | Lot ×",Streak_Boost_Pct,"/×",Streak_Reduce_Pct," por racha",
         " | Pausa ",Pause_Bars,"b tras ",Max_Consec_Losses," losses",
         " | Régimen: pause@",Regime_Bad_Days,"día retoma@",Regime_Good_Days);
