...
input double TP_Trail_Activate_USD       = 0.50;   // USD de profit para activar el trailing con LOT_REF=0.05
input double TP_Trail_Retrace_USD        = 0.30;   // USD de retroceso desde el máximo para cerrar con LOT_REF=0.05
...
void DrawDashboard()
{
   ...
   DashLbl("0","[ MoneyMachine7 v16.8 ]",clrGold,       0*lh,x,y,co,fn);
...
int OnInit()
{
   ...
   string ms=(InpStrategy==0)?"Sweep":(InpStrategy==1)?"Hybrid":"Breakout";
   Print("MM7 v16.8 | LIVE PARITY ENGINE | Mode=",ms,
...
void OnTick()
{
   ...
   if(!g_warmupDone)
   {
      ...
      else
      {
         ...
         {
            g_warmupDone = true;
            Print("MM7 v16.7 | WARMUP LIVE COMPLETADO tras ", secs, "s | M5+M15 barras nuevas | Senales activadas");
         }
         else
         {
