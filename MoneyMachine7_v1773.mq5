//+------------------------------------------------------------------+
//|  MoneyMachine7_v1773.mq5                                        |
//|  v17.73 — v17.72 + DETECTOR DE RÉGIMEN MACRO                   |
//|                                                                  |
//|  CAUSA RAÍZ IDENTIFICADA (datos v17.72):                        |
//|  - Semana 10: WR=54%, net=+$145 (mercado bajista ✓)            |
//|  - Semana 11: WR=79%, net=+$175 (mercado bajista fuerte ✓)     |
//|  - Semana 12: WR=23%, net=-$104 (oro REVIRTIÓ y subió ✗)       |
//|  El EA es SELL-only → cuando el oro sube sostenidamente pierde  |
//|  21 pérdidas de -$155 en Mar 13-19 solo por régimen alcista     |
//|                                                                  |
//|  SOLUCIÓN: DETECTOR DE RÉGIMEN EN 2 NIVELES                    |
//|                                                                  |
//|  Nivel 1 — Tendencia DIARIA:                                   |
//|  Si el precio hoy > precio hace N días → mercado alcista        |
//|  → Reducir lot al 50% (operar pero con cautela)                |
//|                                                                  |
//|  Nivel 2 — Tendencia SEMANAL:                                  |
//|  Si los últimos M días de P&L son todos negativos → PARAR      |
//|  → Suspender nuevas entradas hasta que el mercado gire         |
//|  → Retomar cuando tengamos 2 días positivos seguidos           |
//+------------------------------------------------------------------+
#property copyright "MoneyMachine7"
#property version   "17.73"
#property strict
...
input int    InpMagicNumber      = 177300;
...
input int    Regime_Bad_Days     = 2;     // tras N días negativos seguidos → pausar
...
int OnInit()
{
   ...
   Print("MM7 v17.73 | ",g_sym,
         " | Partial@",Partial_Trigger_Pct," HardCap=$",Hard_Loss_Cap_USD,
         " | Régimen: trend=",Regime_Trend_Bars,"b lot×",Regime_Lot_Scale,
         " pause@",Regime_Bad_Days,"días malos retoma@",Regime_Good_Days,"días buenos");
