//+------------------------------------------------------------------+
//|                                  QUANTUM_SMART_EA.mq5            |
//|           Sistema Inteligente con Filtros Avanzados             |
//|           Market Regime + Order Flow + Adaptive Risk            |
//+------------------------------------------------------------------+
#property copyright "Quantum Smart EA"
...
int OnInit()
{
   ...
   Print("╔═══════════════════════════════════════════════════════════╗");
   Print("║      QUANTUM SMART EA - Sistema Inteligente v2.0         ║");
   Print("╠═══════════════════════════════════════════════════════════╣");
   ...
   Print("╠═══════════════════════════════════════════════════════════╣");
   Print("║  ★ MEJORAS INTELIGENTES ACTIVAS:                         ║");
   Print("║  Market Regime Filter: ", InpUseMarketRegimeFilter ? "ON" : "OFF", "                          ║");
   Print("║  Order Flow Filter: ", InpUseOrderFlowFilter ? "ON" : "OFF", "                             ║");
   Print("║  Adaptive Risk: ", InpUseAdaptiveRisk ? "ON" : "OFF", "                                 ║");
   Print("║  Smart Exit: ", InpUseSmartExit ? "ON" : "OFF", "                                    ║");
   Print("║  Score Mínimo: ", InpMinIntelligentScore, " (Aumentado)                      ║");
   Print("║  Max Trades/Día: ", InpMaxTradesPerDay, " (Calidad > Cantidad)                  ║");
   Print("╠═══════════════════════════════════════════════════════════╣");
