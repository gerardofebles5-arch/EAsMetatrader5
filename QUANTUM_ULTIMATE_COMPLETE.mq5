...
input int    InpMinLearningTrades = 30;      // Trades mínimos para aprender
input double InpMinPatternWinRate = 45.0;    // Win rate mínimo del patrón
input bool   InpUseIntelligentScoring = true; // Scoring inteligente
input int    InpMinIntelligentScore = 70;    // Score inteligente mínimo
...
int OnInit()
{
   ...
   Print("╔═══════════════════════════════════════════════════════════╗");
   Print("║      QUANTUM ULTIMATE AI - Sistema Completo               ║");
   Print("╠═══════════════════════════════════════════════════════════╣");
