...
void DrawDashboard()
{
   ...
   DashLbl("0","[ MoneyMachine7 v16.0 ]",clrGold,       0*lh,x,y,co,fn);
...
int OnInit()
{
   ...
   string ms=(InpStrategy==0)?"Sweep":(InpStrategy==1)?"Hybrid":"Breakout";
   Print("MM7 v16.0 | PREDICTIVE ENGINE | Mode=",ms,
         ...
         " | FIX: BUY bias corregido v16 (MomentumBias reemplaza EMAMomentum)");
