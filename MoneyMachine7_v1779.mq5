//+------------------------------------------------------------------+
//|  MoneyMachine7_v1779.mq5                                        |
//|  v17.79 — DEADLOCK ELIMINADO DEFINITIVAMENTE                    |
//|                                                                  |
//|  RAÍZ DEL PROBLEMA (confirmada en v17.76, v17.77, v17.78):     |
//|  g_regime_paused = true cuando día es negativo                  |
//|  → Mar-10: -$3.73 → pausa permanente → nunca opera más         |
//|  → DEADLOCK: para retomar necesita día positivo,                |
//|    pero para generar día positivo necesita operar               |
//|                                                                  |
//|  SOLUCIÓN DEFINITIVA:                                           |
//|  g_regime_paused ELIMINADO DEL CÓDIGO COMPLETAMENTE             |
//|  El régimen SOLO ajusta g_regime_lot_factor:                    |
//|    día negativo → lot×0.80 (prudente, no pausa)                |
//|    día positivo → lot×1.00 (restaura)                          |
//|                                                                  |
//|  WR TRACKER reemplaza las pausas del régimen:                   |
//|    WR rolling 8 ops < 30% → pausa 3 BARRAS (no días)           |
//|    Se desbloquea en 3 minutos, no en días → NO hay deadlock     |
//|                                                                  |
//|  BALANCE TRAIL desactivado — reduce ganancias igual que         |
//|  pérdidas (sim: $148 vs $311). No ayuda en este contexto.      |
//|                                                                  |
//|  RESTO: v17.75 base intacta (la mejor probada)                  |
//+------------------------------------------------------------------+
#property copyright "MoneyMachine7"
#property version   "17.79"
#property strict
...
input int    WR_Track_Pause_Bars = 3;  // pausa 3 barras cuando WR<30%
...
int OnInit()
{
   ...
   Print("MM7 v17.79 | ",g_sym,
         " | SIN DEADLOCK: regimen solo lot×",Regime_Lot_Scale,
         " | WR_Tracker: pause ",WR_Track_Pause_Bars,"b cuando WR<",WR_Track_Low*100,"%",
         " | Partial$",Partial_USD_Trigger," | Horas:2,7,15,22");
