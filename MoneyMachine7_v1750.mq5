//+------------------------------------------------------------------+
//|  MoneyMachine7_v1750.mq5                                        |
//|  v17.50 — v17.47 IDENTICO excepto: eliminar hora 0             |
//|                                                                  |
//|  ANALISIS COMPARATIVO v17.47 vs v17.49:                         |
//|  v17.47: Net=+$1237 | EV=$25.76 | WR=54%                       |
//|  v17.49: Net=+$462  | EV=$12.17 | WR=58%                       |
//|                                                                  |
//|  QUE SALIO MAL EN v17.49:                                       |
//|  1. Eliminé hora 19 que era WR=67% y +$513 → ERROR GRAVE       |
//|  2. Trail adaptativo dejó pérdidas open 847min vs 324min        |
//|  3. Pérdidas >-$50 empeoraron: 8→9, -$804→-$1,057              |
//|                                                                  |
//|  UNICA MEJORA REAL DISPONIBLE:                                  |
//|  Hora 0: WR=0%, 5 pérdidas, -$405 neto. CERO wins.            |
//|  Sin ella: Net proyectado = $1237 + $405 = $1642               |
//|                                                                  |
//|  TODO LO DEMAS: IDENTICO A v17.47                              |
//|  - SELL only                                                    |
//|  - Horas: 2, 7, 15, 19, 22 (igual v17.47 menos la 0)          |
//|  - Trail fijo 4pts (igual v17.47)                              |
//|  - Partial 40% TP (igual v17.47)                               |
//|  - Risk 2% cap $100 (igual v17.47)                             |
//+------------------------------------------------------------------+
#property copyright "MoneyMachine7"
#property version   "17.50"
#property strict

// Señal — IDENTICO a v17.47
...
// Trailing — IDENTICO a v17.47 (fijo 4pts)
...
// HORAS: v17.47 era 0,2,7,15,19,22
// v17.50: SOLO eliminar hora 0 (WR=0%, -$405 neto puro)
// Mantener 2,7,15,19,22 — especialmente 19 (WR=67%, +$513)
input bool   Use_Hour_Filter     = true;

// Lotaje — IDENTICO a v17.47
...
input int    InpMagicNumber      = 175000;
...
bool IsGoodHour(int hour)
{
   ...
   // v17.47 horas menos la 0 (0 wins, -$405 pérdidas)
   // Mantenemos 19 que tiene WR=67% y +$513 en v17.47
...
int OnInit()
{
   ...
   Print("MM7 v17.50 | SELL ONLY | Horas:2,7,15,19,22 (sin hora 0)",
         " | Trail=",Trail_Distance_Pts,"pts | Partial@",Partial_Trigger_Pct,
...
void OnTick()
{
   ...
   if(ticket>0 && g_openEntry>0){
      ...
      // TRAILING (identico v17.47: fijo 4pts)
      ...
      // PARTIAL CLOSE (identico v17.47: 40% TP)
